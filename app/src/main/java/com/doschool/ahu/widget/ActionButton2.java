...
public class ActionButton2 extends Button {
    ...
    public ActionButton2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ActionButton2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        int colorDrawable=context.getResources().getColor(R.color.new_color);
