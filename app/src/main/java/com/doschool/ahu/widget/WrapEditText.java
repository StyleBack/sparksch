...
public class WrapEditText extends EditText implements View.OnFocusChangeListener,TextWatcher {
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources().getDrawable(R.mipmap.black_delete_icon);
        }
//        mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth(), mClearDrawable.getIntrinsicHeight());
        mClearDrawable.setBounds(0, 0, ConvertUtils.dp2px(20), ConvertUtils.dp2px(20));
        //默认设置隐藏图标
