...
import com.doschool.ahu.appui.infors.chat.ui.viewfeatures.ProfileSummary;
...
public class GroupInfo implements Observer {
    ...
    public static String getTypeName(String type){
        if (type.equals(GroupInfo.publicGroup)){
            return BaseApplication.getContext().getString(R.string.public_group);
        }else if (type.equals(GroupInfo.privateGroup)){
            return BaseApplication.getContext().getString(R.string.discuss_group);
        }else if (type.equals(GroupInfo.chatRoom)){
            return BaseApplication.getContext().getString(R.string.chatroom);
        }
        return "";
    }
