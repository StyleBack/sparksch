 ...
 */
public class ShareDO extends BaseModel implements Serializable {
    private static final long serialVersionUID = 2609851530966944766L;
    ...
    public static class ShareBean implements Serializable{
        private static final long serialVersionUID = -1778612887633545424L;
        /**
         * 微博基础信息
         */
        ...
        //热门评论
        private List<MicroblogCommentVO> hotCommentVOList;
        ...
        public List<MicroblogCommentVO> getHotCommentVOList() {
            return hotCommentVOList;
        }

        public void setHotCommentVOList(List<MicroblogCommentVO> hotCommentVOList) {
            this.hotCommentVOList = hotCommentVOList;
        }
